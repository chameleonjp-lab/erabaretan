...
import type { Command, GameState, PlayerId, PlayMode, PreviewCommandIntent } from "../../packages/game-core/src/index.ts";
...
function previewStatus(state: GameState, intent: PreviewCommandIntent): string {
