...
catalogHashはこの文書内でカード正本を識別するための固定名である。暗号学的なハッシュ化と本番シャッフルの固定値は、P0-05で別途定義する。
...
P0-03は完了とする。共通効果命令の正式な入力型と出力型はP0-04の正本で固定した。次はP0-05「決定的乱数生成器と固定試験値」へ進む。P0-05とP0-06が完了するまで、画面実装と通信実装は開始しない。
