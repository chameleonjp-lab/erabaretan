...
P0-01、P0-02、P0-03は完了しました。残りの仕様作業は次のとおりです。

1. P0-04：共通効果命令の正式な型
2. P0-05：決定的乱数生成器と固定試験値
3. P0-06：ゴールデン試合3件と各試合の最終状態ハッシュ

これらを確定してから、12種類の純粋なルール基盤を実装します。P0-03完了後も、P0-04〜P0-06が終わるまで本実装は開始しません。
