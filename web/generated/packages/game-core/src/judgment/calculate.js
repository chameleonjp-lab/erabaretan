function sumModifier(state, playerId, modifierKind) {
...
function winnerForScores(scores, playerIds) {
 ...
 */
export function calculateJudgment(state) {
...
export function calculateJudgmentBreakdown(state) {
