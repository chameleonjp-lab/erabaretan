...
P2-02では、X01〜X14の境界再通過、複数境界、世界崩壊、同率責任、山札切れ、盾、フィールド上書き、重複命令、不正入力を契約試験へ固定しました。P2-03では不変条件、効果キュー上限、公開状態、応答待ち、preview、結果summaryの秘密情報境界を固定しました。全94件の試験と型検査が通過し、Sol・Highの独立レビューを完了しています。
